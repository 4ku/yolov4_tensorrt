...
class BBoxVisualization():
    ...
    def __init__(self, data_file):
        with open(data_file, 'r') as file:
            classes_list = file.readlines()
        self.cls_dict = {i: n for i, n in enumerate(classes_list)}
        self.colors = gen_colors(len(self.cls_dict))
    ...
    def draw_bboxes(self, img, boxes, confs, clss):
        ...
        for bb, cf, cl in zip(boxes, confs, clss):
            ...
            cls_name = self.cls_dict.get(cl, 'CLS{}'.format(cl)).strip()
